...
namespace NBApp.Migrations
{
    ...
    [Migration("20260813083339_DynamicRolesAdded")]
    partial class DynamicRolesAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NBApp.Models.City", b =>
                {
            ...
            modelBuilder.Entity("NBApp.Models.FeaturePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NBApp.Models.Suburb", b =>
                {
                    b.Property<int>("SuburbID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NBApp.Models.ShippingAddress", b =>
                {
                    b.HasOne("NBApp.Models.Suburb", "Suburb")
                        .WithMany()
            ...
            modelBuilder.Entity("NBApp.Models.Suburb", b =>
                {
                    b.HasOne("NBApp.Models.City", "City")
                        .WithMany("Suburbs")
